...
export class HelpCenterContentResolver {
  constructor(
    private readonly helpCenterContentService: HelpCenterContentService,
  ) {}

  @Mutation(() => HelpCenterContent)
  createHelpCenterContent(
    @Args('createHelpCenterContentInput')
    createHelpCenterContentInput: CreateHelpCenterContentInput,
  ) {
    return this.helpCenterContentService.create(createHelpCenterContentInput);
  }

  @Query(() => [HelpCenterContent])
  findAllHelpCenterContent() {
    return this.helpCenterContentService.findAll();
  }

  @Query(() => HelpCenterContent)
  findOneHelpCenterContent(@Args('id', { type: () => Int }) id: number) {
    return this.helpCenterContentService.findOne(id);
  }

  @Mutation(() => HelpCenterContent)
  updateHelpCenterContent(
    @Args('updateHelpCenterContentInput')
    updateHelpCenterContentInput: UpdateHelpCenterContentInput,
  ) {
    return this.helpCenterContentService.update(
      updateHelpCenterContentInput.id,
      updateHelpCenterContentInput,
    );
  }
