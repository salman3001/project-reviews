...
export class HelpCenterCategoryResolver {
  constructor(
    private readonly helpCenterCategoryService: HelpCenterCategoryService,
  ) {}

  @Mutation(() => HelpCenterCategory)
  createHelpCenterCategory(
    @Args('createHelpCenterCategoryInput')
    createHelpCenterCategoryInput: CreateHelpCenterCategoryInput,
  ) {
    return this.helpCenterCategoryService.create(createHelpCenterCategoryInput);
  }

  @Query(() => [HelpCenterCategory])
  findAllHelpCenterCategor() {
    return this.helpCenterCategoryService.findAll();
  }

  @Query(() => HelpCenterCategory)
  findOneHelpCenterCategor(@Args('id', { type: () => Int }) id: number) {
    return this.helpCenterCategoryService.findOne(id);
  }

  @Mutation(() => HelpCenterCategory)
  updateHelpCenterCategory(
    @Args('updateHelpCenterCategoryInput')
    updateHelpCenterCategoryInput: UpdateHelpCenterCategoryInput,
  ) {
    return this.helpCenterCategoryService.update(
      updateHelpCenterCategoryInput.id,
      updateHelpCenterCategoryInput,
    );
  }
